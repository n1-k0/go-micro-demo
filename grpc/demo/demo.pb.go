...
var file_demo_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x32, 0x33, 0x0a, 0x0b, 0x44, 0x65, 0x6d, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x24, 0x0a, 0x04, 0x44, 0x65, 0x6d, 0x6f, 0x12, 0x0d, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x1a, 0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x3b, 0x64,
...
var file_demo_proto_depIdxs = []int32{
	0, // 0: proto.DemoService.Demo:input_type -> proto.String
	0, // 1: proto.DemoService.Demo:output_type -> proto.String
...
type DemoServiceClient interface {
	Demo(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error)
}
...
func (c *demoServiceClient) Demo(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/proto.DemoService/Demo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoServiceServer interface {
	Demo(context.Context, *String) (*String, error)
}
...
func (*UnimplementedDemoServiceServer) Demo(context.Context, *String) (*String, error) {
...
func _DemoService_Demo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.DemoService/Demo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).Demo(ctx, req.(*String))
	}
